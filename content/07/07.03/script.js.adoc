...
We've just scribbled these down in the feature description for now, but later, once we've teased this scenario apart, we'll be able to use the `Rule` keyword as we shoed you in chapter 4.
