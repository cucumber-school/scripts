...
shot::[3,"Write out the two new scenarios, leaving the original in place."]shot::[4]
...
shot::[5,"removes original long scenario"]shot::[6]
...
shot::[8,"Writes up the other question"]
