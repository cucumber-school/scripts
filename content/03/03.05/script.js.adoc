...
[source, js]
----
Given('{person} is located/standing {int} metre(s) from Sean', function (distance) {
----
shot::[2]
...
We use the `defineParameterType` DSL function from Cucumber to define our new parameter type. shot::[5]
