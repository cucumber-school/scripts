...
* Because Automation should come before Discovery
* Because Formulation should come before Discovery
...
The intended order is Discovery, Formulation then Automation. Our observation was that the the team jumped straight into coding (Automation) then retro-fitted some tests later. The discovery only happened when Tamsin tested the feature.
...
* That there are no unknown unknowns on your project
...
Read Daniel Terhorst-North's [original blog post](https://dannorth.net/2010/08/30/introducing-deliberate-discovery/).
