...
Woop! Our scenario is passing for the first time. As long as this is the only message anyone ever shouts, we're good to ship this thing!
...
Instead of writing a note on our TODO list, let's write another failing scenario that will guide us towards a solution that won't be able to have a hard-coded message.
