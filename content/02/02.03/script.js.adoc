...
shot::[8]
Edit `package.json` and change the `test` line under the `scripts` from it's default to `cucumber-js` shot::[9]
...
Finally, we're going to install `hamjest` in order to have more expressive assertions shot::[11]
