...
audio::02.03.ruby.audio.mp3[]

Before we get started make sure you have a modern version of Ruby installed,
and the Bundler gem. Open a command-prompt and check the Ruby version, shot::[] and the version of Bundler, Ruby's package manager: shot::[]
