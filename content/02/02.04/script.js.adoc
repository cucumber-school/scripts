...
shot::[11]
We’ll paste them into a JavaScript file under a new directory called `step_definitions` underneath the `features` directory. I’ll just call it `steps.rb`.

shot::[12]
Before running our process again, we need to import the `Given`,
shot::[13]
`When`
shot::[14]
