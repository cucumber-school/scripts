...
Instead of writing a note on our TODO list, let's write another test that shouts a different message. Usually we'd expect a developer to do this using a unit test, but to keep things simple in this lesson, we're going to write another scenario. shot::[5]
