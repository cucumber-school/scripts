...
A full list of Cucumber's configuration properties can be found by passing the `--help` flag on the command line. shot::[12, highlight top of output] Or using the abbreviated version `-h` shot::[13]
