...
Finally, let's install the pretty-formatter and run Cucumber. shot::[1c, "npm install then npm test"]
...
shot::[2, "Scroll slowly through the output to show all scenarios"]
...
// FEDE - the character sequence "\--" used in this adoc script gets rendered as "--" and that is what should be typed in at the command line!
