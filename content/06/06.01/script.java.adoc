...
In this lesson you've learnt how to filter the set of scenarios to run using scenario names and line numbers. In the next lesson we'll look at filtering using a Gherkin feature called Tags.
