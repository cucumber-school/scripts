...
First, let's delete the contents if cucumber.properties. shot::[3] Now, Cucumber will run all scenarios. shot::[4, run Cucumber from IntelliJ by right clicking on RunCucumberTests]
