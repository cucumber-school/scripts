...
[source, gherkin]
----
include::../code/java/17-merge-repeated-buy-steps/shouty/src/test/resources/shouty/premium_shouts.feature[lines=13]
----
...
[source, gherkin]
----
include::../code/java/18-rename-scenario/shouty/src/test/resources/shouty/premium_shouts.feature[lines=13]
----
...
[source, gherkin]
----
include::../code/java/19-split-scenario/shouty/src/test/resources/shouty/premium_shouts.feature[lines=16..28]
----
