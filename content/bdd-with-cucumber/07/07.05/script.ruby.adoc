...
There are still a couple of problems with this scenario.shot::[1] One is the name of the scenario. It really doesn’t tell us anything at all.

[source, gherkin]
----
include::../code/ruby/17-merge-repeated-buy-steps/features/premium_shouts.feature[lines=13]
----
...
shot::[2,"Updates the name of the scenario"]

[source, gherkin]
----
include::../code/ruby/18-rename-scenario/features/premium_shouts.feature[lines=13]
----
...
shot::[3,"a shot where we duplicate the original scenario, twice"]
shot::[4,"a shot where we change the `Scenario: ` name of each of the duplicated scenarios to match what I say in the audio, then clean up the steps to match that intent"]shot::[5]

We can tuck each one under a `Rule` keyword, shot::[6,"a shot where we add a Rule keyword above each one."] removing the rules from the feature file's free-text description:
shot::[7,""removing the rules from the feature file's free-text description field" we need a shot zooming out to show the whole feature, and deleting the description that we added in the earlier lesson."]

And then we change the scenarios steps accordingly shot::[8]shot::[9]

[source, gherkin]
----
include::../code/ruby/19-split-scenario/features/premium_shouts.feature[lines=16..28]
----
...
shot::[10,"removes original long scenario"]shot::[11]
...
shot::[12,"Writes up the question."]

[source, gherkin]
----
include::../code/ruby/20-capture-questions/features/premium_shouts.feature[lines=3..4]
----
...
shot::[13,"Writes up the other question"]

[source, gherkin]
----
include::../code/ruby/20-capture-questions/features/premium_shouts.feature[lines=3..5]
----
