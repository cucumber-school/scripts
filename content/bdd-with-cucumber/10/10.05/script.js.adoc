...
[source,js]
----
include::../code/js/09-remove-todo-tag-and-bug-from-scenario/src/shouty.js[lines=68..71]
----
...
[source,js]
----
include::../code/js/09-remove-todo-tag-and-bug-from-scenario/src/shouty.js[lines=70]
----
