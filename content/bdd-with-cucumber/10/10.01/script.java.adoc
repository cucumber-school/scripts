...
We have it marked with a `@todo` tag on it,shot::[1] but those scenarios are filtered out by our `RunCucumber` settings.
...
We're going to start work on the scenario now, so let's change that tag to a `@wip` to indicate that it's "Work In Progress":shot::[2]

[source,gherkin]
----
include::../code/java/00-initial-commit/shouty/src/test/resources/shouty/premium_shouts.feature[lines=27..31]
----

Now when we run all our tests, we should see the failing scenario: shot::[3]
...
[source,gherkin]
----
include::../code/java/01-move-scenario-under-the-right-rule/shouty/src/test/resources/shouty/premium_shouts.feature[lines=11..31]
----
...
[source,gherkin]
----
include::../code/java/02-rename-scenario/shouty/src/test/resources/shouty/premium_shouts.feature[lines=20]
----
...
[source,gherkin]
----
include::../code/java/02-rename-scenario/shouty/src/test/resources/shouty/premium_shouts.feature[lines=19..22]
----
...
[source,gherkin]
----
include::../code/java/03-changed-values-in-scenario/shouty/src/test/resources/shouty/premium_shouts.feature[lines=19..25]
----
