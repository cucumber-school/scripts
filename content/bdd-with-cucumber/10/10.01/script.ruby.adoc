...
We have it marked with a `@todo` tag on it,shot::[2] but those scenarios are filtered out in our default `bundle exec rake` command.
...
You might be worried about losing this bug ID. We could keep it in a comment shot::[], a tag shot::[], or in the description of the Scenario.
