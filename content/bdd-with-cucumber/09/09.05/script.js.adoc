...
First, create an empty file called `shout_steps.js` shot::[1], and import the `When` method for defining steps.
...
Now we can cut and paste those steps from the existing `steps.js` file into this new one: shot::[2]
