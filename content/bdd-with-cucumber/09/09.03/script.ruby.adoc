...
[source,ruby]
----
include::../code/ruby/07-move-network-to-an-accessor-in-world/features/support/world.rb[lines=12..14]
----
...
[source,ruby]
----
include::../code/ruby/09-use-new-network-range-method/features/step_definitions/steps.rb[lines=3..5]
----
...
[source,ruby]
----
include::../code/ruby/09-use-new-network-range-method/features/support/world.rb[lines=16..16]
----
