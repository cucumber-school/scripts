...
[source,java]
----
include::../code/java/02-introduce-world-class/shouty/src/test/java/shouty/StepDefinitions.java[lines=27]
    ...
include::../code/java/02-introduce-world-class/shouty/src/test/java/shouty/StepDefinitions.java[lines=31..33]
----
...
[source,java]
----
include::../code/java/04-move-network-onto-the-world/shouty/src/test/java/shouty/StepDefinitions.java[lines=60..62]
----
