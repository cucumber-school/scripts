...
[source,java]
----
include::../code/java/12-replace-hardcoded-lucy-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=19..25]
----
...
[source,java]
----
include::../code/java/12-replace-hardcoded-lucy-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=27..30]
----
...
[source,java]
----
include::../code/java/12-replace-hardcoded-lucy-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=43..46]
----
...
[source,java]
----
include::../code/java/13-ambiguous-step-definition/shouty/src/test/java/shouty/StepDefinitions.java[lines=27..30]
----
...
[source,java]
----
include::../code/java/14-replace-hardcoded-sean-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=32..36]
----
