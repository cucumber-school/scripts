...
[source,java]
----
include::../code/java/13--step12-replace-hardcoded-lucy-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=19..25]
----
...
[source,java]
----
include::../code/java/13--step12-replace-hardcoded-lucy-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=27..30]
----
...
[source,java]
----
include::../code/java/13--step12-replace-hardcoded-lucy-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=43..46]
----
...
Using your new found Cucumber expression skills from the last lesson, you’ll know that if we replace the word Lucy here with a 'word' expression, we’ll have the name passed into our step definition as an argument, here. Now we can use that as the key in the hash/map.

[source,java]
----
include::../code/java/14--step13-ambiguous-step-definition/shouty/src/test/java/shouty/StepDefinitions.java[lines=27..30]
----
...
shot::[6, "Delete a_person_named_Sean() and replace Sean instance with HashMap element"]
Let’s remove the old step definition, and fetch Sean from the hash/map here where he shouts his message.

[source,java]
----
include::../code/java/15--step14-replace-hardcoded-sean-instance/shouty/src/test/java/shouty/StepDefinitions.java[lines=32..36]
----
