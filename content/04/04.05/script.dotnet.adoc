...
Now we can store Lucy in a key in that Dictionary. We’ll use her name as the key, hard-coding it for now.shot::[6,modify a_person_named_Lucy]
...
Finally, where we check Lucy’s messages heard here in the assertion, we need to fetch her out of the Dictionary. shot::[7, modify lucy_hears_Sean_s_message]
