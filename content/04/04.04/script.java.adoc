...
[source,java]
----
include::../code/java/07--step06-broken-stepdef-implmentation/shouty/src/test/java/shouty/StepDefinitions.java[lines=24..32]
----
...
[source,java]
----
include::../code/java/08--step07-network-as-an-instance-field/shouty/src/test/java/shouty/StepDefinitions.java[lines=10..15]
----
...
[source,java]
----
include::../code/java/09--step08-using-a-before-hook/shouty/src/test/java/shouty/StepDefinitions.java[lines=18..21]
----

[source,java]
----
include::../code/java/09--step08-using-a-before-hook/shouty/src/test/java/shouty/StepDefinitions.java[lines=31..39]
----
...
[source,gherkin]
----
include::../code/java/10--step09-change-second-scenario/shouty/src/test/resources/shouty/shout.feature[lines=16..20]
----
...
[source,java]
----
include::../code/java/11--step10-delete-unused-stepdef/shouty/src/test/java/shouty/StepDefinitions.java[]
----
...
[source,java]
----
include::../code/java/12--step11-delete-move_to/shouty/src/main/java/shouty/Person.java[]
----
