...
[source,java]
----
include::../code/java/00-initial-commit/shouty/src/test/java/shouty/StepDefinitions.java[lines=10..34]
----
...
[source,java]
----
include::../code/java/00-initial-commit/shouty/src/test/resources/shouty/shout.feature[]
----
