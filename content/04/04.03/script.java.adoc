...
[source,gherkin]
----
include::../code/java/01--step01-description-added/shouty/src/test/resources/shouty/shout.feature[lines=1..7]
----
...
[source,gherkin]
----
include::../code/java/03--step02-rule-keyword-added/shouty/src/test/resources/shouty/shout.feature[lines=8..17]
----
...
[source,java]
----
include::../code/java/03--step02-rule-keyword-added/shouty/src/test/java/shouty/StepDefinitions.java[lines=16..16]
----
...
[source,java]
----
include::../code/java/03--step02-rule-keyword-added/shouty/src/test/java/shouty/StepDefinitions.java[lines=21..21]
----
...
[source,java]
----
include::../code/java/03--step02-rule-keyword-added/shouty/src/main/java/shouty/Person.java[lines=19..20]
----
...
[source,gherkin]
----
include::../code/java/04--step03-first-scenario-rewritten/shouty/src/test/resources/shouty/shout.feature[lines=8..19]
----
...
[source,gherkin]
----
include::../code/java/05--step04-empty-scenarios-added/shouty/src/test/resources/shouty/shout.feature[lines=21..25]
----
...
[source,java]
----
include::../code/java/06--step05-snippets-added/shouty/src/test/java/shouty/StepDefinitions.java[lines=24..34]
----
