...
[source,js]
----
include::../code/js/02-rule-keyword-added/features/step_definitions/steps.rb[lines=7]
----
...
[source,js]
----
include::../code/js/02-rule-keyword-added/lib/shouty.rb[lines=12..14]
----
...
[source,js]
----
include::../code/js/05-snippets-added/features/step_definitions/steps.rb[lines=10..16]
----
