...
Our two scenarios are examples of how Shouty can broadcast a shout to other users. This is one of the main business rules, which we can document using the Rules keyword.shot::[4, "add Rules keyword"] We'll learn more about this in a later chapter.
