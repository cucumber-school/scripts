...
[source,gherkin]
----
include::../code/ruby/13-replace-hardcoded-sean-instance/features/hear_shout.feature[lines=8..20]
----
...
[source,gherkin]
----
include::../code/ruby/14-move-givens-into-background/features/hear_shout.feature[lines=8..10]
----

shot::[3, "bundle exec cucumber"]
...
[source,gherkin]
----
include::../code/ruby/14-move-givens-into-background/features/hear_shout.feature[lines=12..20]
----
