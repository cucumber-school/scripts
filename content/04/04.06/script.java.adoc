...
[source,gherkin]
----
include::../code/java/15--step14-replace-hardcoded-sean-instance/shouty/src/test/resources/shouty/shout.feature[lines=8..20]
----
...
[source,gherkin]
----
include::../code/java/16--step15-move-givens-into-background/shouty/src/test/resources/shouty/shout.feature[lines=8..10]
----
...
[source,gherkin]
----
include::../code/java/16--step15-move-givens-into-background/shouty/src/test/resources/shouty/shout.feature[lines=12..20]
----
