...
[source,gherkin]
----
include::../code/java/14--step14-replace-hardcoded-sean-instance/shouty/src/test/resources/shouty/shout.feature[lines=8..20]
----
...
shot::[2, "move Given steps into background"]
We can literally move them into the background, using a background keyword, like this:

[source,gherkin]
----
include::../code/java/15--step15-move-givens-into-background/shouty/src/test/resources/shouty/shout.feature[lines=8..10]
----
...
shot::[4, "Feature file, showing Background and shortened scenarios"]
...
[source,gherkin]
----
include::../code/java/15--step15-move-givens-into-background/shouty/src/test/resources/shouty/shout.feature[lines=12..20]
----

Notice we just went straight into When steps in our scenarios.shot::[5] That’s absolutely fine. We still have a context for the scenario, but we’ve chosen to push it off into the background.
