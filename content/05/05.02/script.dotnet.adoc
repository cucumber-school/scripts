...
[source,c#]
----
include::../code/dotnet/03--step03-edit-step-definitions-to-get-back-to-green/Shouty/Shouty.Specs/StepDefinitions/StepDefinitions.cs[lines=15]
----
...
[source,gherkin]
----
include::../code/dotnet/04--step04-remove-incidental-details-from-range-scenarios-and-fix-stepdefs/Shouty/Shouty.Specs/Features/HearShout.feature[lines=15..27]
----
