...
If a scenario needs to document specific range, that can still be done by explicitly including a "Given the range is ..." step. shot::[5a,"Highlight step definition @Given() annotation and the_range_is() method"]
