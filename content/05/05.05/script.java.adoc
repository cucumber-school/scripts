...
shot::[16,"run cucumber"] Run the unit test again… and it’s passing. Great.
...
Now the scenario is much more readable. shot::[23,"show existing stepdef code"]
...
Now we can fill out the rest of our new step definition. shot::[27]shot::[27.2]
...
Let's check that we're still green shot::[28,"run cucumber"]shot::[28.2] -- and we are!
