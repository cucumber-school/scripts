...
We have to add a new step definition too shot::[24,"sean_shouts_the_following_message"]. It doesn't need a parameter in the Cucumber Expression shot::[25] -- the DocString gets passed as a string argument to the step definition automatically.shot::[26]
