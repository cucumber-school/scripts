...
shot::[24,"show existing stepdef code"]
We have to add a new step definition too shot::[25,"sean_shouts_the_following_message"]. It doesn't need a parameter in the Cucumber Expression shot::[26] -- the DocString gets passed as a string argument to the step definition automatically.shot::[27]

Now we can fill out the rest of our new step definition. shot::[28]
