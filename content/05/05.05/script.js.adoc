...
[source,js]
----
include::../code/js/18-add-test-to-networktest/test/network.test.js[lines=47..50]
----
...
We have to add a new step definition too shot::[26,"sean_shouts_the_following_message"]. It doesn't need a parameter in the Cucumber Expression shot::[27] -- the DocString gets passed as an argument to the step definition automatically.shot::[28]
