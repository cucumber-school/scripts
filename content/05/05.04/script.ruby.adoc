...
If you call the `transpose` method on the table shot::[3,add Transpose annotation to stepdef], Cucumber will turn each row into a column before passing it to the step definition.
