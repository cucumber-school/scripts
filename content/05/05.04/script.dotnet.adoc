...
It works similarly to CreateSet. shot::[17,"add CreateSet call"] The CompareToSet is an extension method on the Table class from the Assist namespace, and you need to pass the list of objects that you would like to compare the table with. shot::[18,"highlight actualMessages argument"]
